...
use backend\assets\AdminLte2Asset;
use yii\helpers\Url;
    ...
    <div class="wrapper">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <small><?=date('d-m Y H:i',$user->created_at)?></small>
                                    </p>
                                </li>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <?=\backend\models\MenuAdmin::getData()?>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?=date("d.m.Y")?> <a href="https://t.me/JamshidbekAkhlidinov">Jamshidbek Axlidinov</a>.</strong> All rights
            reserved.
        </footer>
